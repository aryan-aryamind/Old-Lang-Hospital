...
def create_timeout_gather(input_type='speech', action='', method='POST', barge_in=True, 
    ...
    """
    Helper function to create consistent timeout behavior with "Are you still there?" prompts.
...
def voice_webhook():
    ...
    try:
        ...
        # Welcome message
        response.say("Hello, I am Arya an AI Voice Assistant! Welcome to ABC Hospital.",
        )
        
        # Main menu with timeout handling
        gather = Gather(
            input='speech',
            action='/server-rag',
            method='POST',
        ...
        gather2.say("Are you still there? Would you like to ask anything else? I would be happy to help you.")
